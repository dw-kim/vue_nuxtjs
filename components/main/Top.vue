...
.main .menu { width: 100%; height: 116px; display: inline-block; text-align: -webkit-center;}
.main .menu .category { width:110px; height:115px; background-color: deepskyblue;}
.main .menu .category-menu { width: 150px; height:400px; position: absolute; background-color:#FFF; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 10px 0 0 0; }
